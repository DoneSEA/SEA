...
HD_PWD='C:/Users/Opex9020/Desktop/SEA-Tutorial/Experiment-of-SEA/IP_Core/UART-IP/Driver_UART/Driver_UART.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_UART.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driver_UART.tcl
