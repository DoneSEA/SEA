...
HD_PWD='C:/Users/Opex9020/Desktop/SEA-Tutorial/Experiment-of-SEA/IP_Core/IIC-IP/Driver_IIC/Driver_IIC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_IIC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driver_IIC.tcl
