...
HD_PWD='C:/Users/Opex9020/Desktop/SEA-Tutorial/Experiment-of-SEA/IP_Core/HDMI-IP/Driver_HDMI/Driver_HDMI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_HDMI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driver_HDMI.tcl
