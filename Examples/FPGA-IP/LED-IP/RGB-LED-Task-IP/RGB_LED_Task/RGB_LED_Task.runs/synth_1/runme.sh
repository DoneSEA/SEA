...
HD_PWD='C:/Users/Opex9020/Desktop/SEA-Tutorial/Experiment-of-SEA/IP_Core/LED-IP/RGB-LED-Task-IP/RGB_LED_Task/RGB_LED_Task.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RGB_LED_Task.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RGB_LED_Task.tcl
