...
HD_PWD='C:/Users/Opex9020/Desktop/SEA-Tutorial/Experiment-of-SEA/IP_Core/LED-IP/LED-Task-IP/LED_Task/LED_Task.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LED_Task.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LED_Task.tcl
