...
HD_PWD='C:/Users/Opex9020/Desktop/SEA-Tutorial/Experiment-of-SEA/IP_Core/Frequency-Divider-IP/Clk_Division/Clk_Division.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Clk_Division.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Clk_Division.tcl
