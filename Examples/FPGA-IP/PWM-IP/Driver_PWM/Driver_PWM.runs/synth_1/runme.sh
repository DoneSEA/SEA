...
HD_PWD='C:/Users/Opex9020/Desktop/SEA-Tutorial/Experiment-of-SEA/IP_Core/PWM-IP/Driver_PWM/Driver_PWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_PWM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driver_PWM.tcl
