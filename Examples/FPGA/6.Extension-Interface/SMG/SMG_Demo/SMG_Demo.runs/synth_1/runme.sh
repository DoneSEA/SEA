...
HD_PWD='D:/SEA-Tutorial/Experiment-of-SEA/FPGA-Demo-Project/SMG-Demo/SMG_Demo/SMG_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SMG_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SMG_Demo.tcl
