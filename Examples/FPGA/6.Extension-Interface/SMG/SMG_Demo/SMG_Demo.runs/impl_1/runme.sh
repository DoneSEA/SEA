...
HD_PWD='D:/SEA-Tutorial/Experiment-of-SEA/FPGA-Demo-Project/SMG-Demo/SMG_Demo/SMG_Demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SMG_Demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SMG_Demo.tcl -notrace
