...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/Opex9020/Desktop/SEA-Tutorial/Experiment-of-SEA/FPGA-Demo-Project/Camera-Demo/Camera_Demo/Camera_Demo.cache/compile_simlib/riviera"
  fi
