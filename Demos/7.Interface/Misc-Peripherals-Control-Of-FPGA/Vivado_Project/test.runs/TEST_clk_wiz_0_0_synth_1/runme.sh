...
HD_PWD='C:/Users/dell/Desktop/xilinx/test/IO_LED_sw/test/test.runs/TEST_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TEST_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TEST_clk_wiz_0_0.tcl
